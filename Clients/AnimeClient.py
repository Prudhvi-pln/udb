...
class AnimeClient(BaseClient):
    ...
    def _get_kwik_links(self, ep_id):
        ...
        '''
        response = self._send_request(self.download_link_url + ep_id, None, False, None, self.cookies)
    ...
    def _get_kwik_links_v2(self, ep_link):
        ...
        response = self._get_bsoup(ep_link, None, None, self.cookies)
    ...
    def search(self, keyword):
        ...
        response = self._send_request(search_url, None, True, None, self.cookies)
    ...
    def fetch_episodes_list(self, target):
        ...
        raw_data = json.loads(self._send_request(list_episodes_url, None, False, None, self.cookies))
        ...
        if last_page > 1:
            for pgno in range(2, last_page+1):
                ...
                episodes_data.extend(self._send_request(f'{list_episodes_url}&page={pgno}', None, True, None, self.cookies))
